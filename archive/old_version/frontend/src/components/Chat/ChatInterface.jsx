...
function ChatInterface() {
  ...
  const { 
    ...
    businessInfo,
    updateBusinessInfo,
    startAssessment: initAssessment
  } = useAssessment();
  ...
  useEffect(() => {
    const initializeSession = async () => {
      try {
        ...
        // Set initial welcome message if no message in response
        const welcomeMessage = response.message || 'Welcome to the TradeKing Export Assessment. I will help you evaluate your business\'s export readiness. Let\'s begin by understanding your business better.';
  ...
  const handleShowValidation = () => {
    ...
    setRequiresAction(false);
    setActionType(null);
    setBusinessInfo(businessContext);
  };
  ...
  const handleValidationComplete = async (validatedData) => {
    ...
    try {
      ...
      setBusinessInfo(updatedContext);
